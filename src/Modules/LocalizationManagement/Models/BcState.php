...
class BcState extends Model implements EventNotifiableContract {
    ...
    {
        return $this->belongsTo(BcCountry::class,'country_id');
    }
    ...
    {
        return $this->hasMany(BcCity::class,"state_id");
    }
    ...
    public function quarters(): HasManyThrough
    {
        return $this->hasManyThrough(
            BcQuarter::class, // le model/table final (qu'on veut retourner)
            BcCity::class, // le model/table intermédiare
            ...
            (new BcCity)->getKeyName() // [PK] du model intermédiare
        );
    }
